 ...
 */
public class MediatorChatAdapter extends BaseAdapter {

    private ArrayList<ChatDetailBean> mChatList = new ArrayList<ChatDetailBean>();
    private Activity mActivity;
     ChatDetailBean bean = null;
    public MediatorChatAdapter(Activity mActivity, ArrayList<ChatDetailBean> mChatList) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null)
        {
            ...
            convertView = inflater.inflate(R.layout.mediator_chat_row_item, null);
