 ...
 */
public class CounsellingChatDetailsAdapter extends BaseAdapter {

    private ArrayList<ChatDetailBean> mChatList = new ArrayList<ChatDetailBean>();
    private Activity mActivity;
     ChatDetailBean bean = null;
    public CounsellingChatDetailsAdapter(Activity mActivity, ArrayList<ChatDetailBean> mChatList) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null)
        {
            ...
            convertView = inflater.inflate(R.layout.counsel_chat_details_row_item, null);
            ...
            holder.seen_message = (TextView) convertView.findViewById(R.id.seen_message);
    ...
    bean = mChatList.get(position);
            ...
            if(bean.isSeen()) {
                holder.seen_message.setBackgroundResource(R.drawable.read);
            }
            else {
                holder.seen_message.setBackgroundResource(R.drawable.unread);
