...
/*    int skin_array[] = {R.drawable.text_skin1,R.drawable.text_skin2,R.drawable.text_skin3,R.drawable.text_skin4,
    ...
    public MySecretFeedAdapter(LayoutInflater inflater, List<Secret> list, Context context) {
        loadData(inflater, list, context);
    }

    public MySecretFeedAdapter(LayoutInflater inflater, List<Secret> list, Context context, boolean canShare) {
        loadData(inflater, list, context);
...
*/
    ...
    public static class ViewHolder {
        ...
        //   public LinearLayout sentenct_ayout;
