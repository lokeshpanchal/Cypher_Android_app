package com.helio.cypher.connection;
...
import com.helio.cypher.StaticObjectDTO.IFriendSettingDTO;
import com.helio.cypher.StaticObjectDTO.RiskWordDTO;
import com.helio.cypher.StaticObjectDTO.SchoolDTO;
import com.helio.cypher.StaticObjectDTO.SecretCategoryDTO;
import com.helio.cypher.StaticObjectDTO.StataicObjectDTO;
import com.helio.cypher.WebserviceDTO.ChatMessageDTO;
import com.helio.cypher.WebserviceDTO.ClearMysecretObjectDTO;
...
import com.helio.cypher.WebserviceDTO.GetAllNotificationObjecttDTO;
import com.helio.cypher.WebserviceDTO.GetCommentObjectDTO;
import com.helio.cypher.WebserviceDTO.GetIfriendMessageObjectDTO;
...
import com.helio.cypher.WebserviceDTO.GetPendingFriendObjectDTO;
...
import com.helio.cypher.WebserviceDTO.GetmyRecievedObjectDTO;
import com.helio.cypher.WebserviceDTO.LoginbjectDTO;
...
import com.helio.cypher.WebserviceDTO.SchoolRatingObjectDTO;
import com.helio.cypher.WebserviceDTO.ScratchCouponObjectDTO;
import com.helio.cypher.WebserviceDTO.SearchSecretObjectDTO;
import com.helio.cypher.WebserviceDTO.SecretObjectDTO;
import com.helio.cypher.WebserviceDTO.SeenbyObjectDTO;
import com.helio.cypher.WebserviceDTO.SendCouponCodeObjectDTO;
import com.helio.cypher.WebserviceDTO.SendMessageObjectDTO;
...
import com.helio.cypher.WebserviceDTO.SetflagUnflagCommentObjectDTO;
...
import com.helio.cypher.appCounsellingDTO.RattingQuestionDTO;
import com.helio.cypher.models.AllIfriendobjectDTO;
import com.helio.cypher.models.CallLogDTO;
import com.helio.cypher.models.Comment;
import com.helio.cypher.models.GetCallsessionObjectDTO;
import com.helio.cypher.models.GetCurrentDateObjectDTO;
import com.helio.cypher.models.GetImpactRatingObjectDTO;
import com.helio.cypher.models.IfriendAcceptObjectDTO;
import com.helio.cypher.models.IfriendListDTO;
import com.helio.cypher.models.IfriendPendingRequestDTO;
import com.helio.cypher.models.IfriendRemoveObjectDTO;
...
import com.helio.cypher.models.SecretPushNotificayionObjectDTO;
import com.helio.cypher.models.SendImpactRatingDTO;
import com.helio.cypher.models.SentImpactratinganswerObjectDTO;
...
;
    ...
    private StataicObjectDTO ParseStaticdata(String jsonResponse) {
        ...
        String status = "", state = "", keywords = "", requestduration = "", maxfriend = "", safeguard_update_date = "",session_duration = "", school_name = "", school_code = "", school_id = "";
        try {
            Object object = new JSONTokener(jsonResponse).nextValue();
            if (object instanceof JSONObject) {
                JSONObject jsonObject = new JSONObject(jsonResponse);
                ...
                if (status != null && status.equalsIgnoreCase("true")) {
                    ...
                    for (int i = 0; i < setting_array.length(); i++) {
                        ...
                        iFriendSettingDTO = new IFriendSettingDTO(requestduration, maxfriend, session_duration , safeguard_update_date);
    ...
    public PetAvtarInfoDTO SetPetInfo(SetPetInfoObjectDTO contact) {
        String jsonData = new Gson().toJson(contact);
        if (Constants.primary_server) {
            json = makeConnection(MainServer, jsonData);
    ...
    private String ParseLogin(String jsonResponse) {
        String username = "";
        String age = "", gender = "", pin = "", security_answer = "", security_question = "";
        String me2s = "", hugs = "", hearts = "", pet_name = "",tandc = "",
                isverified = "", isflagged = "", secrets = "", birthday = "",safe_guard = "", disclaimer = "";
