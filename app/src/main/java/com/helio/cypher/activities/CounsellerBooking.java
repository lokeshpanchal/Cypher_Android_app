...
import com.helio.cypher.appCounsellingDTO.AcceptTermsConditionDataDTO;
import com.helio.cypher.appCounsellingDTO.AppointmentCancelDTO;
import com.helio.cypher.appCounsellingDTO.BookAppointmentDataDTO;
...
import com.helio.cypher.appCounsellingDTO.GetCounsellorAppointmentDTO;
import com.helio.cypher.appCounsellingDTO.GetUnavailableDataDTO;
import com.helio.cypher.appCounsellingDTO.SuggestNewTimeDTO;
...
public class CounsellerBooking extends Activity {
    ...
    TextView cancel_button = null, session_left = null, show_bookdate = null, show_date = null, select_checkbox = null,
             accepttermsandc = null, unselect = null, book_counsel = null, cancel_time = null, time_ok = null;
    Context ct = null;
    ...
    int noofdays = 0;
    RelativeLayout time_layout = null, time_lyout_bg, booking_appoint_layout = null, booking_lyout = null, start_booking_layout = null;
...
*/
            ...
            public void onDateSelected(Date date) {
                ...
                try {
                    ...
                    if (Dayname != null && !Dayname.equalsIgnoreCase("Sunday")) {
                        ...
                        // Toast.makeText(ct,""+noofdays,Toast.LENGTH_SHORT).show();
    ...
    private void ConfirmPopup() {
        ...
        if (Suggested_Object == null)
            ...
            updateAlert.setMessage("Are you sure you want to suggest new time for counselling using \"" + Mode + "\" at \"" + Dayname + " " + daymont + " " + MonthName + ", " + YearName + " " + Hour + ":" + Minute + " " + Ampmtext + "\"?");
                        ...
                        try {
                            ...
                            if (Suggested_Object != null) {
                                try {
                                    ...
                                    progress_bar.setVisibility(View.VISIBLE);
                                    suggestNewTimeDTO = new SuggestNewTimeDTO(MainActivity.enc_username, Suggested_Object.getString("clcnslrun01"), Suggested_Object.getString("apntmnt_id"), "User", sent_time);
                                ...
                                bookAppointmentDataDTO = new BookAppointmentDataDTO(MainActivity.enc_username, Mode, is_samecounseller, sent_time, qrCode, Agency_id
                                        , "" + MainActivity.session_left, appintmentid, "" + latitudeTarget, "" + longitudeTarget, "User", "", counseller_id, counsellor_name, session_duration,agent_id);
                    ...
                    if (object instanceof JSONObject) {
                        ...
                        if (status != null && status.equalsIgnoreCase("true")) {
                            ...
                            if (json_array != null && json_array.length() > 0)
                            {
                                ...
                                {
                                    counselor_unaval_time_form = getLocalTimewithsecond(UserInfoobj.getString("from"));
                                }

                                if (UserInfoobj.has("to"))
                                {
                                    counselunaval_timeto = getLocalTimewithsecond(UserInfoobj.getString("to"));
                                }


                                String tp = UserInfoobj.getString("to");
                                String from = UserInfoobj.getString("from");

                                try {


                                    boolean is_counsel = UserInfoobj.getBoolean("is_unaval");
