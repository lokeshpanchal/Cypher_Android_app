...
import com.helio.cypher.WebserviceDTO.SeenbyCouponCodeDTO;
import com.helio.cypher.WebserviceDTO.SendCouponCodeObjectDTO;
import com.helio.cypher.WebserviceDTO.SendCouponDTO;
        ...
        if (MainActivity.stataicObjectDTO != null && MainActivity.stataicObjectDTO.getSchoolDTOs() != null) {
           /* if (schools == null || schools.isEmpty())
            ...
            try {
                ...
                if (!isMatch) {
                    stopProgress();
                    new ToastUtil(this, "Invalid Coupon Code.");
                }
        ...
        try {
            ...
            for (String userItem : item.getUsers()) {
                if (userItem.equals(MainActivity.enc_username)) {
                    stopProgress();
                    new ToastUtil(this, "Coupon code already submitted by you");
